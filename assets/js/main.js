...
const CANDIDATES = [
  ...
  { order:  3, name: "BATTISTONE MARIA TERESA", cv: "assets/docs/cv-grande-sicilia-03.pdf", casellario: "assets/docs/casellario-grande-sicilia-03.pdf" },
  ...
  { order:  7, name: "CUNSOLO FRANCESCO", cv: "assets/docs/cv-grande-sicilia-07.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
  { order:  8, name: "FERRAUTO IRENE", cv: "assets/docs/cv-grande-sicilia-08.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
  { order:  9, name: "LA ROSA ANTONELLA", cv: "assets/docs/cv-grande-sicilia-09.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
  { order: 10, name: "LOMBARDO MARIA CONCETTA", cv: "assets/docs/cv-grande-sicilia-10.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
  { order: 11, name: "MICELI LAURA MARIA PAOLA", cv: "assets/docs/cv-grande-sicilia-11.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
  { order: 12, name: "NICOTRA SALVATORE NAZZARENO", cv: "assets/docs/cv-grande-sicilia-12.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
  { order: 13, name: "PAPPALARDO MELISSA", cv: "assets/docs/cv-grande-sicilia-13.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
  { order: 14, name: "SANTOCONO BERNADETTE", cv: "assets/docs/cv-grande-sicilia-14.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
  { order: 15, name: "SFERRAZZO ALFIO", cv: "assets/docs/cv-grande-sicilia-15.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
  { order: 16, name: "SGROI MASSIMO", cv: "assets/docs/cv-grande-sicilia-16.pdf", casellario: "assets/docs/casellario-grande-sicilia-combinato.pdf" },
];
